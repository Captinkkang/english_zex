...
<style>
  ...
  /* 배지 스타일 */
  .type-badge { display: inline-block; padding: 6px 20px; background: #123456; color: white; font-weight: 900; font-size: 0.9rem; border-radius: 4px 15px 4px 15px; margin-bottom: 20px; }
  ...
  .halo-id { width: 80px; height: 80px; background: #00A3FF; color: white; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 2.2rem; font-weight: 900; }
  
  /* 인풋 스타일 */
  input { height: 80px; border: 3.5px solid #e2e8f0; border-radius: 15px; font-size: 1.8rem; padding: 0 25px; width: 320px; text-align: center; font-weight: 900; transition: all 0.3s; }
